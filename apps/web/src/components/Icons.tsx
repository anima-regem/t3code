...
// Official IBM Bob icon from https://github.com/academic-initiative/skillsbuild
export const BobIcon: Icon = ({ className, ...props }) => {
  const id = useId().replaceAll(":", "");
  const shadowGradId = `${id}-bob-shadow`;
  const bgGradId = `${id}-bob-bg`;
  ...
  return (
    ...
    >
      <defs>
        ...
        <linearGradient id={bgGradId} x1="0" y1="32" x2="32" y2="0" gradientUnits="userSpaceOnUse">
